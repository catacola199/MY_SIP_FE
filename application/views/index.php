               ...
               <div class="swiper-wrapper d-flex align-items-center">
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <a href="https://e-katalog.lkpp.go.id/"></a><img src="assets/img/brand/client1.png" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <a href="https://e-katalog.lkpp.go.id/"></a><img src="assets/img/brand/client2.png" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="assets/img/brand/client3.png" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="assets/img/brand/client4.png" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="assets/img/brand/client5.png" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="assets/img/brand/client7.png" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="assets/img/brand/client8.png" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="assets/img/brand/client9.png" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="assets/img/brand/client10.png" alt="">
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="tp-blog-box mb-30 wow tpfadeLeft" data-wow-duration=".6s" data-wow-delay=".4s">
                  <div class="tp-blog-item">
                     ...
                     <div class="tp-blog-info">
                        <h3 class="tp-blog-title"><a href="blog-details.php">How to add a count up animation the webflow site.</a>
                        </h3>
            ...
            <div class="col-xl-6 col-lg-6">
               <div class="tp-blog-box mb-30 wow tpfadeRight" data-wow-duration=".7s" data-wow-delay=".6s">
                  <div class="tp-blog-item">
                     ...
                     <div class="tp-blog-info">
                        <h3 class="tp-blog-title"><a href="blog-details.php">How to grow your business with collax digital
                              solution.</a></h3>
                        <p>At Collax we specialize in designing, building, shipping and scaling beautiful, usable
                           products
                           with blazing-fast</p>
         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="tp-blog-button text-center mt-30">
                  <a class="tp-btn" href="blog-details.php">View Case Studies</a>
               </div>
            </div>
         </div>
      </div>
