...
<head>
   ...
   <title> SIP - Technic Details</title>
                  ...
                  <div class="tp-main-menu tp-menu-black tp-bs-menu tp-bp-menu text-center">
                     <nav id="mobile-menu">
                        <ul>
                           ...
                           <li class="has-dropdown "><a href="#" class="disable">Service</a>
                              <ul class="submenu text-start">
                                 <li><a href="service-details.php">Technic</a></li>
                                 <li><a href="service-details.php">Conformity Test</a></li>
                                 <li><a href="service-details.php">Calibration</a></li>
                              </ul>
                           </li>
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     ...
                     <a href="about.html" class="tp-btn-white-border">Lets work together <i class="far fa-arrow-right"></i></a>
                  </div>
               </div>
            </div>
         </div>
