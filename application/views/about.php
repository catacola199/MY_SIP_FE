...
<main>
   ...
   <!-- mission-area-start -->
   <div class="tp-mission-area pt-50 p-relative">
               ...
               <div class="tp-mission-tab-section pb-10">
                  <nav>
                     <div class="nav tp-mission-tab " id="nav-tab" role="tablist">
                        ...
                        <button class="nav-links" id="nav-Vission-tab" data-bs-toggle="tab" data-bs-target="#Vission" type="button" role="tab" aria-controls="nav-Vission-tab" aria-selected="true"><span>Our
                              Vission</span></button>

                        <button class="nav-links" id="nav-Value-tab" data-bs-toggle="tab" data-bs-target="#Value" type="button" role="tab" aria-controls="nav-Value-tab" aria-selected="true"><span>Our
                              Value</span></button>
                     </div>
                  </nav>
               </div>
         ...
         <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".7s">
               <div class="tp-chose-item mb-30">
                  <div class="tpchosebox tpchosebox-three">
                     <div class="tpchosebox__icon fea-color-price mb-30">
                        <a href="#"><i class="ri-money-dollar-circle-line"></i></a>
                     </div>
                     <div class="tpchosebox__content">
                        <h4>Price</h4>
                        <p>Offers affordable prices</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
               <div class="tp-chose-item mb-30">
                  <div class="tpchosebox tpchosebox-two">
                     <div class="tpchosebox__icon fea-color-respon mb-30">
                        <a href="#"><i class="ri-shield-check-line"></i></i></a>
                     </div>
                     <div class="tpchosebox__content">
                        <h4>Responsibility</h4>
                        <p>Have responsibility for the quality of goods</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
               <div class="tp-chose-item mb-30">
                  <div class="tpchosebox">
                     <div class="tpchosebox__icon fea-color-service mb-30">
                        <a href="#"><i class="ri-service-line"></i></i></a>
                     </div>
                     <div class="tpchosebox__content">
                        <h4>Service</h4>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow tpfadeUp" data-wow-duration=".3s" data-wow-delay=".5s">
               <div class="tp-chose-item mb-30">
                  <div class="tpchosebox">
                     <div class="tpchosebox__icon fea-color-service mb-30">
                        <a href="#"><i class="ri-file-text-line"></i></i></a>
                     </div>
                     <div class="tpchosebox__content">
                        <h4>Document</h4>
                        <p>Complete National Documents</p>
                     </div>
                  </div>
               </div>
            </div>
